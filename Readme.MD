...
To obtain the 'DT.tidy tidy' data table and the file 'TidyMeasurement.txt', the following steps have to be taken:
    ...
    Step5 - Print the 'DF.tidy' data frame and load the 'TidyMeasurement.txt' to a text editor
            to see the results.
...
The codebook file 'codebook.md' is the description of the contents of the tidy data file, 'TidyMeasurement.txt' and the 'DT.tidy' data table. 
